...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 46, 266, 313);
		...
		lblNewLabel_1.setBounds(10, 11, 90, 24);
		...
		lblNewLabel_1_4.setBounds(286, 11, 151, 24);
		w_appointment.add(lblNewLabel_1_4);
		
		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(286, 46, 151, 30);
		...
		lblNewLabel_1_4_1.setBounds(286, 137, 151, 24);
		...
		btn_selDoctor.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 16));
		btn_selDoctor.setBounds(286, 172, 151, 29);
		w_appointment.add(btn_selDoctor);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(447, 46, 252, 313);
		...
		lblNewLabel_1_1.setBounds(456, 11, 123, 24);
		w_appointment.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_4_1_1 = new JLabel("Randevu ");
		lblNewLabel_1_4_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 16));
		lblNewLabel_1_4_1_1.setBounds(286, 282, 151, 24);
		...
		btn_addAppoint.setBounds(286, 317, 151, 29);
		...
		w_scrollAppoint.setBounds(10, 11, 689, 348);
